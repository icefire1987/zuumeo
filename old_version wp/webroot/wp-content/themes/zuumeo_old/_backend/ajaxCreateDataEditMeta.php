				...
				<table cellpadding="0" cellspacing="0" style="width:100%;">
					<tr>
						...
						<td class="editor_content_data">
							...
							'.clearer(8).'
							<div><b>MOMENTAN:</b> '.getMetaTitle($post_id).'<div class="editor_table_data_help_info" style="margin-top:5px;">INFO: Seitentitel bzw. Eingabe + <a href="/wp-admin/admin.php?page=acf-options-wrterstze" target="_blank"><u>Standardtitel</u></a></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="editor_content_data">
							...
							'.clearer(8).'
							<div><b>MOMENTAN:</b> '.getMetaDescription($post_id).'<div class="editor_table_data_help_info" style="margin-top:5px;">INFO: Eingabe ersetzt <a href="/wp-admin/admin.php?page=acf-options-wrterstze" target="_blank"><u>Standardbeschreibung</u></a></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="editor_content_data">
							...
							'.clearer(8).'
							<div><b>MOMENTAN:</b> '.getMetaKeywords($post_id).'<div class="editor_table_data_help_info" style="margin-top:5px;">INFO: Eingabe + <a href="/wp-admin/admin.php?page=acf-options-wrterstze" target="_blank"><u>Standardkeywords</u></a></div>
						</td>
					</tr>
